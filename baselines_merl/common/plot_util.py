...
from baselines_merl.logger import read_json, read_csv
...
def load_results(root_dir_or_dirs, enable_progress=False, enable_monitor=True, verbose=False):
    '''
