import pytest
from baselines_merl.common.tests.envs.identity_env import DiscreteIdentityEnv, BoxIdentityEnv, MultiDiscreteIdentityEnv
from baselines_merl.run import get_learn_function
from baselines_merl.common.tests.util import simple_test
from baselines_merl.common.tests import mark_slow
