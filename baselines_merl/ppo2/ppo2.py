...
from baselines_merl.common.policies import build_policy
try:
    from mpi4py import MPI
except ImportError:
    MPI = None
from baselines_merl.ppo2.runner import Runner
...
def learn(*, network, env, total_timesteps, eval_env = None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4,
            ...
            log_interval=10, nminibatches=4, epochs=4, cliprange=0.2,
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines_merl.common/policies.py/build_policy and arguments to a particular type of network
    ...
    for update in range(1, nupdates+1):
        ...
        if update % log_interval == 0 or update == 1:
            ...
            logger.logkv('mean', safemean([epinfo['r'] for epinfo in epinfobuf]))
            logger.logkv('eplenmean', safemean([epinfo['l'] for epinfo in epinfobuf]))
            if eval_env is not None:
                logger.logkv('eval_mean', safemean([epinfo['r'] for epinfo in eval_epinfobuf]) )
